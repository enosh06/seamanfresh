...
const Footer = () => {
    return (
        <footer className="bg-ocean text-white py-16 mt-20 border-t border-white/10">
                ...
                <div>
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="text-2xl font-bold font-display tracking-tight">
                            SEAMAN <span className="text-ocean-light">FRESH</span>
                        </span>
                    </div>
                    ...
                    <ul className="space-y-3">
                        <li>
                            <Link to="/" className="text-white/70 hover:text-white transition-colors flex items-center gap-2">
                                <span className="w-1.5 h-1.5 bg-ocean-light rounded-full"></span> Home
                            </Link>
                        </li>
                        <li>
                            <Link to="/products" className="text-white/70 hover:text-white transition-colors flex items-center gap-2">
                                <span className="w-1.5 h-1.5 bg-ocean-light rounded-full"></span> Fresh Fish
                            </Link>
                        </li>
                        <li>
                            <Link to="/cart" className="text-white/70 hover:text-white transition-colors flex items-center gap-2">
                                <span className="w-1.5 h-1.5 bg-ocean-light rounded-full"></span> Your Cart
                            </Link>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <p className="flex items-center gap-3 text-white/80">
                            <Mail size={18} className="text-ocean-light" />
                            seamanfreshfish.inc@gmail.com
                        </p>
                        <p className="flex items-center gap-3 text-white/80">
                            <Phone size={18} className="text-ocean-light" />
                            +1 (709) 986-8050
                        </p>
                        <p className="flex items-start gap-3 text-white/80">
                            <MapPin size={18} className="text-ocean-light mt-1" />
